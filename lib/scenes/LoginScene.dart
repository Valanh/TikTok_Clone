              ...
              child: OutlinedButton.icon(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                      context,
                      CupertinoPageRoute(
                          builder: (context) => const LoginWidthPhNumber()));
                }, //bắt sự kiện click
              ),
            ),
              ...
              child: OutlinedButton.icon(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                      context,
                      CupertinoPageRoute(
                          builder: (context) => const LoginWidthEmail()));
                }, //bắt sự kiện click
              ),
            ),
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.push(context,
                    CupertinoPageRoute(builder: (context) => RegScene()));
              },
              child: const Text("Don't have an account? Sign up",
                  style: TextStyle(
                      fontSize: 15,
                      color: Color.fromARGB(255, 40, 147, 196))),
            ),
          ],
        ),
      ),
